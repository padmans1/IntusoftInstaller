...
!define APP_DIR_PATH "$APPDATA\Intuvision Labs Pvt Ltd"
...
OutFile "Setup.exe"
InstallDir "$PROGRAMFILES64\My application"
ShowInstDetails show
ShowUnInstDetails show

Section "MainSection" SEC01
MessageBox MB_ICONINFORMATION|MB_OK "$EXEDIR"
createDirectory "${APP_DIR_PATH}"
CopyFiles "\ReportTemplates\*" "${APP_DIR_PATH}"
